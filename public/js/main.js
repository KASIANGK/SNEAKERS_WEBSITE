...
boutonMode.addEventListener("click", () => {
  ...
  if (body.classList.contains("dark-mode")) {
    ...
    background.style.backgroundImage = 'url("./public/modules/SKY-LIGHT.jpg")';
...
let imagesPieces = ["./public/modules/sh1.png", 
    "./public/modules/sh2.png", "./public/modules/Sujet4.png", "./public/modules/Sujet5.png",
